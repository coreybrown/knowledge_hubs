...
DOMAINS = [
    ("01_introduction",            "Introduction",        "☕",
     "#B07B4F", "Where pour over begins — what it is, the brew-method family tree, and how to read this base."),
    ("02_history",                 "History & Origins",   "📜",
     "#9B6A43", "From Melitta's paper filter and the Chemex to Japan's kissaten and the third-wave V60 boom."),
    ("03_equipment",               "Equipment & Drippers","⚙️",
     "#6E7E8A", "Drippers, kettles, filters, and scales — the V60, Kalita, Chemex, Origami, and immersion cousins."),
    ("04_coffee_beans",            "Coffee Beans & Roast","🌱",
     "#7A9A3E", "Origin, varietals, processing, roast levels, and freshness — the raw material of the cup."),
    ("05_grinding",                "Grinding",            "🔩",
     "#A8762F", "Burrs, grind size, and particle distribution — the single most important variable."),
    ("06_water",                   "Water",               "💧",
     "#3D7E96", "Hardness, alkalinity, TDS, and temperature — the 98% of your cup that's easy to ignore."),
    ("07_brewing_technique",       "Brewing Technique",   "🌀",
     "#B5612E", "Ratio, bloom, pour patterns, agitation, and drawdown — the levers you control."),
    ("08_recipes",                 "Recipes & Methods",   "📖",
     "#C0492F", "Official, competition, and community recipes — each a precise, repeatable spec."),
    ("09_science_and_extraction",  "Science & Extraction","🔬",
     "#5E6C99", "Solubility, extraction yield, TDS, the brewing control chart, and refractometry."),
    ("10_tasting_and_sensory",     "Tasting & Sensory",   "👅",
     "#B14A7A", "Cupping, the flavor wheel, acidity, body, and building a palate."),
    ("11_culture_and_industry",    "Culture & Industry",  "🏭",
     "#8567A8", "Roasters, cafés, the World Brewers Cup, gear brands, and coffee sourcing."),
    ("12_reference",               "Reference",           "📚",
     "#6F8A86", "Glossary, troubleshooting, master index, comparison tables, and the quick-start checklist."),
]
...
def search_overlay():
    return (
        ...
        '<line x1="13.5" y1="13.5" x2="18" y2="18" stroke="currentColor" '
        'stroke-width="2" stroke-linecap="round"/></svg>'
        '<input type="text" id="searchInput" placeholder="Search 144 notes — '
        'grind, bloom, extraction…" autocomplete="off">'
        '<kbd>Esc</kbd></div>'
