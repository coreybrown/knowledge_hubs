---
tags: [recipes, official, clever, immersion]
aliases: [Clever Dripper Official Recipe, Clever Dripper recipe, Clever recipe]
...
bloom_time_s: 30
brew_time: "3:30"
roast: medium, also light and dark
source: "Clever Coffee Dripper, published method"
---

# 🍵 Clever Dripper Official Recipe

The [[The Clever Dripper|Clever Dripper]] solves immersion's one inconvenience with a clever valve: a **silicone stopper in the base that stays shut until you set the dripper on a cup**, which opens it and drains the brew through a paper filter. So you get the full-immersion sweetness and **near-foolproof consistency** of a [[French Press]], but the clean cup of a paper filter. It's the most forgiving brewer in the book. ✅

> [!example] ☕ Recipe Card
> | Field | Value |
> |---|---|
> | Brewer | [[The Clever Dripper]] |
> | Dose | 18 g |
> | Water | 290 g total |
> | Ratio | 1:16 |
> | Temp | 93-96°C |
...
> | Source | Clever Coffee Dripper, published method |
> | **Resulting cup** | Sweet, full, rounded; clean paper-filtered clarity with immersion body |
