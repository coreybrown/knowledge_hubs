---
tags: [reference, beginner, checklist]
aliases: [Pour Over Quick Start Checklist, Quick start, Beginner checklist]
domain: Reference
---
...
1. [ ] Heat water to about **93°C** (just off the boil, rested ~30 s) → [[Water Temperature for Brewing]]
2. [ ] Weigh **18 g** of beans → [[The Brew Ratio]]
3. [ ] Grind to **medium** (like coarse table salt) → [[Grind Size for Pour Over]]
4. [ ] Put the filter in the dripper and **rinse it** with hot water; discard the rinse → [[Pre-Wetting the Filter]]
...
7. [ ] **Bloom:** pour **~50 g** of water to wet all the grounds, then wait **30–45 s** → [[The Bloom]]
8. [ ] **First pours:** add water in slow concentric circles up to **~150 g** → [[Pouring Technique]]
9. [ ] **Final pours:** continue to **288 g** total, keeping the bed gently submerged → [[Pulse vs Continuous Pouring]]
10. [ ] **Drawdown:** let it drain; aim to finish around **2:45–3:15** → [[The Drawdown]]
11. [ ] Give the dripper a gentle swirl or tap to settle the bed if needed

## 🍵 Taste & Adjust

12. [ ] Let it cool slightly, then taste → [[How to Taste Coffee]]
13. [ ] **Too sour?** Grind finer or brew hotter next time
14. [ ] **Too bitter?** Grind coarser or brew cooler next time
15. [ ] Change **one variable per brew** and keep notes → [[Dialing In Grind Size]]
