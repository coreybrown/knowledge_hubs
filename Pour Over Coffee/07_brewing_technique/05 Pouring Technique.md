---
tags: [brewing-technique, pouring, kettle-control]
aliases: [Pouring Technique, How to pour, Pour patterns, Kettle control]
domain: Brewing Technique
---

# 🫖 Pouring Technique

How you pour water is the most hands-on lever in the whole brew. The same coffee, grind, and ratio can yield a clean, sweet cup or a hollow, sour one depending purely on **where** you pour, **how high** from, **how fast**, and how steadily you control the [[Gooseneck Kettles|kettle]]. This note covers the mechanics; how you *sequence* those pours is [[Pulse vs Continuous Pouring|pulse vs continuous]].

## The Four Pour Variables ⚙️

| Variable | Lever | Effect |
|---|---|---|
| Pattern | Center vs spiral | Evenness across the bed |
| Height | Close vs high | [[Agitation and Turbulence\|Agitation]] energy |
| Flow rate | Slow vs fast | Bed level & turbulence |
| Placement | Where on the bed | Avoiding the walls |
...
Pour from **low** (a few centimeters above the bed) for a soft, calm entry; pour from **high** for a thin, energetic stream that drills into the grounds and adds [[Agitation and Turbulence|turbulence]]. Height is your agitation dial: higher means more extraction energy, but also more risk of digging a crater. Most balanced recipes pour from a low-to-moderate height.
