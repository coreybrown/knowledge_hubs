---
tags: [styles, reference, judging]
aliases: [BJCP and Style Guidelines, BJCP, Beer Style Guidelines, Style Categories]
domain: Styles
---
...
similar bodies categorize IPAs and assign the vital-stats ranges used
throughout the [[IPA Styles]] domain.

> [!note] Who writes the guidelines?
> Three frameworks dominate: the **BJCP Guidelines** (used by homebrew
> competitions), the **Brewers Association Style Guidelines** (used by the Great
> American Beer Festival and World Beer Cup), and **internal styles** breweries
> use themselves. They broadly agree but differ in category names and limits.

## How the BJCP Treats IPAs

The BJCP scatters IPA-family beers across several categories rather than
...
In competition, a beer is judged *against its declared style*: a clear,
brilliant West Coast IPA entered as a [[New England IPA]] would score poorly for
being "out of style," not for being a bad beer. See
[[Tasting and Evaluating IPAs]] and [[Sensory Training and Panels]].

> [!tip] Use guidelines as a map, not a cage
> For drinkers, style guidelines are a vocabulary for what to expect. For
> brewers, they are a starting reference. For the [[Specialty and Experimental IPAs]]
> frontier, they are simply the last edition's snapshot.
