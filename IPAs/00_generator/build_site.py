...
DOMAINS = [
    ...
    ("06_science_and_sensory","Science & Sensory", "🔬",
     "#3D7E96", "Bitterness chemistry, biotransformation, haze, and off-flavors."),
    ("07_drinking_an_ipa",    "Drinking an IPA",   "🍻",
     "#C99A1E", "Glassware, freshness, food pairing, and regional drinking culture."),
    ("08_best_ipas",          "Best IPAs",         "🏆",
     "#B14A55", "Curated best-of lists, by style and by region."),
    ("09_industry_and_culture","Industry & Culture","🏭",
     "#5E6C99", "Breweries, key figures, the business of brewing, and beer culture."),
    ("10_reference",          "Reference",         "📚",
     "#8567A8", "Glossary, master index, timeline, statistics, and FAQ."),
]
...
def topbar():
    return (
        ...
        '<span class="brand-name">IPA <b>Knowledge Base</b></span></a>'
...
def page_shell(title, body, pages, active_slug, extra_head=""):
    return (
        ...
        f"<title>{html.escape(title)} · IPA Knowledge Base</title>"
...
def render_home(pages, linkmap):
    ...
    para = render_inline(
        "An IPA is a [[Hops]]-forward [[Beer Flavor Wheel|pale ale]] defined by "
        ...
        "modern brewing innovation is painted.", ctx)

    paths = [
        ("\U0001F195", "New to beer",
         "Start with the fundamentals and learn to taste.",
         [("What Is an IPA", "what-is-an-ipa"),
          ("How to Taste an IPA", "how-to-taste-an-ipa")]),
        ("\U0001F373", "Want to brew one",
         "Recipe formulation and the full brewing process.",
         [("Brewing Guide", "brewing-guide"),
          ("Recipe Formulation", "recipe-formulation")]),
        ("\U0001F6D2", "Want to drink the best",
         "Curated picks and how to keep beer fresh.",
         [("Best IPAs", "best-ipas"),
          ("IPA Freshness and Shelf Life", "ipa-freshness-and-shelf-life")]),
        ("\U0001F913", "Want the deep science",
         "Bitterness chemistry and the thiol frontier.",
         [("Science and Sensory", "science-and-sensory"),
          ("Thiols and Hop Burst", "thiols-and-hop-burst")]),
    ]
    path_cards = []
    ...
    hero = (
        ...
        '<div class="hero-eyebrow">A field guide to the India Pale Ale</div>'
        ...
        '<div class="hstat"><b>10</b><span>domains of knowledge</span></div>'
        '<div class="hstat"><b>18</b><span>IPA styles mapped</span></div>'
        '</div></div></section>')
