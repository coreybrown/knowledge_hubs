...
def domain_illustration(folder, color):
    inner = {
        "01_introduction": _INTRO,
        "02_history": _HISTORY,
        "03_styles": _STYLES,
        "04_ingredients": _INGREDIENTS,
        "05_brewing_guide": _BREWING,
        "06_science_and_sensory": _SCIENCE,
        "07_drinking_an_ipa": _DRINKING,
        "08_best_ipas": _BEST,
        "09_industry_and_culture": _INDUSTRY,
        "10_reference": _REFERENCE,
    }.get(folder, _INTRO)
...
_TIMELINE = [
    ...
    (2, "Early 2010s","The hazy/NEIPA emerges as a defined style, soft and juicy",
        "the-new-england-ipa-emergence"),
    (2, "Mid–late 2010s","Substyle explosion: Brut, Milkshake, Cold, Brett, Sour",
        "modern-ipa-diversification"),
    (2, "~2018",   "Cold IPA pairs lager yeast with a crisp hop showcase",
        "cold-ipa"),
...
def page_diagrams():
    return {
        "the-ipa-brewing-process-overview": brewing_flow(),
        "hop-additions-and-timing":         hop_timing(),
        "timeline-of-ipa-history":          history_timeline(),
        "beer-flavor-wheel":                flavor_wheel(),
        "ipa-style-comparison-table":       style_map(),
    }
