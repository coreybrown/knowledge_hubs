---
tags: [science, hops, aroma, thiols, yeast]
aliases: [Thiols and Hop Burst, Polyfunctional Thiols, Thiolized Yeast, Hop Burst]
domain: Science
---

# Thiols and Hop Burst

If one class of molecules explains the explosive tropical intensity of the modern
hazy IPA, it is the **polyfunctional thiols**. These sulfur-containing compounds are
perceptible at almost unimaginably low concentrations and have become the central
obsession of cutting-edge IPA brewing.
...
|---|---|---|
| 3-Mercaptohexan-1-ol | 3MH (3SH) | Grapefruit, passionfruit |
| 3-Mercaptohexyl acetate | 3MHA | Tropical, intense passionfruit |
| 4-Mercapto-4-methylpentan-2-one | 4MMP | Blackcurrant, "catty," box tree |
...
stages rather than the bittering addition. This both preserves
[[Hop Aroma Compounds|volatile oils]] and maximizes the delivery of **thiol
precursors**.
...
thiol-rich, and specially processed "thiol-boosted" hop products are now sold (see
[[Hop Products and Formats]]).

## Why Hazy IPAs Lean on Thiols

The [[New England IPA]] is the natural showcase: low bittering, big late and dry
charges, active-fermentation hopping, and increasingly a thiolized strain from the
[[IPA Yeast Strains|IPA yeast lineup]]. Together these make the most of a fragile,
spectacular aroma.
