---
tags: [product-execution, outcomes, outputs, feature-factory, belief]
aliases: [Outcomes Over Outputs, Outcomes vs Outputs, Outcome Over Output]
...
| **PM role** | [[The Product Organization Matrix\|Facilitator]] / backlog administrator | [[The Product Organization Matrix\|Owner]] of the result |
...
The [[The Product Organization Matrix|Product Organization Matrix]] frames this exactly: the PM as **Owner** (accountable for an outcome) versus **Facilitator** (organizes people to ship features). Outcome teams need owners.

> [!warning] Output language is a cultural tell
...
- [[Feature Specification|Specs]] open with the *outcome* and the metric ("Outcome Oriented" is the first behavior), not a feature list.
- [[Sound Product Decision-Making|Decisions]] are judged by the change they produce, and you *write down the prediction* so you can check it.
- [[Shipping and Launch|Launches]] aren't done at 100% rollout. They're done when you've measured the outcome.
- The [[The 10-50-90 Execution Framework|10/50/90 framework]]'s entire purpose is to avoid spending effort building outputs you haven't validated will produce outcomes.
...
- **Define the outcome metric in the [[Writing PRDs and Specs|spec]], before building.** No metric, no build. This one rule kills more feature-factory behavior than any reorg.
...
- **Change the way you report up.** Lead [[Executive Communication|executive updates]] with outcomes moved, not features shipped. You train the org to value what you report.
