---
tags: [reference, glossary, definitions, terminology]
aliases: [Glossary of Product Management Terms, Glossary, PM Glossary, PM Terminology]
domain: Reference
---

# Glossary of Product Management Terms

A plain-language definition for the vocabulary used across the Atlas. Each entry is one or two sentences; where a full note exists, the term links to it. Alphabetical. When a definition reflects a specific author or model, I attribute it.
...
**Backlog** — The prioritized list of work a team could do. Managing a backlog is a *task*, not the job — confusing the two is a [[Myths and Misconceptions|core myth]].
...
**Conversion Rate** — The share of users who complete a target action (sign-up, purchase). A foundational [[Product Analytics and Metrics|product metric]].
...
**DHM Model** — Gibson Biddle's strategy test: a good strategy should **D**elight customers, be **H**ard to copy, and be **M**argin-enhancing. See [[The DHM Model]].
...
**Eisenhower Matrix** — A 2×2 of urgent × important used to triage tasks: do, decide, delegate, delete. See [[The Eisenhower Matrix]].
...
**Impact-Effort Matrix** — A prioritization 2×2 plotting expected impact against effort to find quick wins. See [[Prioritization Frameworks]].
...
**LNO Framework** — Shreyas Doshi's effort-allocation model sorting tasks into **L**everage, **N**eutral, and **O**verhead. See [[The LNO Framework]].
...
**RICE** — A scoring model ranking ideas by **R**each × **I**mpact × **C**onfidence ÷ **E**ffort. See [[RICE and Scoring Models]].
...
**Technical Debt** — The future cost incurred by choosing a fast, imperfect solution now; a recurring [[Product Quality|quality]] trade-off.
...
## Continue Reading
- [[The Frameworks Toolkit]] — the full set of frameworks named above, each with its own note.
- [[The Master Competency Matrix]] — where these terms map onto the competency model.
- [[The PM Tool Landscape]] — the software that operationalizes many of these concepts.
- [[The Product Management Canon]] — the books these ideas come from.
