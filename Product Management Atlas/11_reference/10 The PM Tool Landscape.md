...
The newest category, and the one reshaping the job fastest — PMs now ship working prototypes themselves. Serves [[AI in Prototyping and Delivery]].
...
## Continue Reading
- [[Character, Competency, and Craft]] — why tools are the easy-to-teach layer, and what isn't.
- [[AI in Prototyping and Delivery]] — the vibe-coding category in depth.
- [[Writing Evals for AI Products]] — why evals tooling is the new must-have.
- [[The PM Competency Model]] — the competencies these tools actually serve.
- [[Product Management Templates]] — what to put *into* Notion, Figma, and ChatPRD.
