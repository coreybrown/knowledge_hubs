...
Three forces stack. **The band** is the primary gate — raw total competence. **The floor rules** tighten as you climb: at PM you just can't be failing a whole category; by LPM you can't be merely "Good" at anything that matters. **Tenure** is additive — even a high scorer waits, because some judgment only comes from reps.

## Why the floors tighten — and the tenure gate exists

This is the part of the design I'm proudest of. A pure sum lets a PM buy their way up by being spectacular at two things and absent on five. The rising floor closes that loophole: seniority isn't just *more* skill, it's the *elimination of holes*. A Senior PM with a glaring gap is a liability precisely because the org now relies on them where they're weak. The tenure clock guards against the other failure — the fast learner who scores high before they've seen enough go wrong to have real [[Product Sense and Judgment|judgment]]. You can't cram experience.
...
> - **It implies skills are additive and fungible. They aren't.** A 4 in stakeholder management does not offset a 1 in delivery; the score says it does.
...
> - **It can become the goal.** The moment people optimize the *score* instead of the *craft*, you've built a [[Outcomes Over Outputs|feature factory for performance reviews]] — activity dressed as growth.
...
So I use the number as a **floor and a conversation-starter, never the final call**. It's excellent for answering "is this person clearly *not* ready" and for forcing an honest, transparent bar. It's dangerous as the thing that *grants* a promotion — that decision belongs to calibrated human judgment ([[Calibration and Promotion]]), with the score as one input. The behavioral [[The Master Competency Matrix|matrix]] and its [[The Proficiency Scale\|0–2 rubric]] carry the nuance the number can't.

> [!note] Pairs with the ladder, not instead of it
> Score bands are a *mechanism*; they don't define what each level *means*. That's the job of [[The Product Career Ladder]] and [[What Changes at Each Level]]. The score tells you *whether* someone clears APM→PM; the ladder tells you what being a PM actually *is*.

## Continue Reading
- [[Calibration and Promotion]] — why the human call has to sit on top of the number.
- [[The Proficiency Scale]] — the 1–5 scale the score is built from, and its limits.
- [[Common Assessment Pitfalls]] — the biases numeric gating dampens, and the ones it creates.
- [[The Product Career Ladder]] — what the levels the score gates actually mean.
- [[Running a Performance Review]] — where a score becomes a leveling decision in practice.
