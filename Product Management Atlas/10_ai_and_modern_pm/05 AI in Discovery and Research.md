...
Discovery is where AI delivers its most immediate, least controversial win for PMs. The grunt work of research — transcribing, tagging, theming, summarizing across hundreds of inputs — was always a time sink that crowded out the actual thinking. AI collapses it. What took a research team two weeks now takes an afternoon. That's not a marginal speedup; it changes how often you can afford to listen.

## What just got cheap

You can now synthesize interviews, support tickets, app-store reviews, sales-call notes, and survey responses in hours instead of weeks. **Dovetail**, the research repository most PM teams already use, shipped AI Docs in its Fall 2025 launch — Claude-powered, it generates **evidence-backed PRDs with citations back to the source clips.** That citation-to-source link is the part I care about: it's synthesis you can *audit*.
...
I'm bullish on AI in discovery, but it has specific, dangerous failure modes. Name them so you can guard against them.

> [!warning] What AI synthesis gets wrong
> - **Smoothing over the outlier.** The single weird interview that contained the real insight gets averaged into a tidy theme. Discovery breakthroughs often live in the outlier; summarization is designed to erase it.
> - **Confident hallucinated themes.** The model will name a pattern that isn't there, in fluent prose, with no tell. Without source citations you can't catch it.
...
Use AI to do the synthesis you'd never have had time for — but keep your hands dirty. Watch a few raw sessions every week. The model can tell you what users said; it cannot tell you what they meant, and that gap is where [[Product Sense and Judgment|product judgment]] is made. See [[User Research and Discovery]] for the underlying craft this sits on top of.

## Continue Reading
- [[Continuous Discovery]] — the discipline AI now makes operationally cheap.
- [[Voice of the Customer]] — the competency AI accelerates.
- [[User Research and Discovery]] — the craft underneath the tooling.
- [[The Opportunity Solution Tree]] — where synthesized insight should land.
- [[The PM Tool Landscape]] — where Dovetail and friends sit.
- [[AI in Prototyping and Delivery]] — the next stage after discovery.
