---
tags: [frameworks, lean-startup, mvp, eric-ries, build-measure-learn, experimentation]
aliases: [Build-Measure-Learn and the MVP, Build-Measure-Learn, MVP, Minimum Viable Product, Lean Startup]
...
> [!note] The loop, planned in reverse
> **Learn:** what's the riskiest assumption? What do we need to know?
> **Measure:** what evidence would confirm or kill it?
> **Build:** the *minimum* artifact that generates that evidence.
...
> [!warning] The most abused acronym in the field
...
This is the engine under [[Continuous Discovery|continuous discovery]] and the operating mode for the [[The Impact-Likelihood Matrix|Strategic Initiatives]] quadrant: high-impact, low-likelihood bets you *must* de-risk before committing. It's the practical sibling of [[Hypothesis-Driven Development|hypothesis-driven development]] (frame the assumption as a falsifiable hypothesis, then the MVP is your test) and it leans on [[Experimentation and A-B Testing|experimentation]] for the rigorous measurement once you've got traffic. The throughline across all of them is the same conviction the Atlas keeps returning to: [[The Four Big Product Risks|value risk]] is the assumption most likely to kill you, so test *that* first and cheapest.

> [!tip] Not everything needs an MVP
