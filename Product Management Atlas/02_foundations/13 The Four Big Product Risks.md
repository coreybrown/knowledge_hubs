...
| **Viability** | Does it work for *our business*, across margin, legal, brand, sales, and partners? | **PM** | A product users love that the business can't sustain |
...
## Continue Reading
- [[Understanding Trade-offs]] for making the call across the four axes when they conflict.
- [[Continuous Discovery]] for the practice built to attack value risk before delivery.
- [[Product Teams vs Feature Teams]] for why discovery and delivery must live on one team.
- [[The Product, Design, and Engineering Venn]] for the ownership split, in picture form.
- [[Business Acumen and Models]] for the business fluency that viability risk demands.
