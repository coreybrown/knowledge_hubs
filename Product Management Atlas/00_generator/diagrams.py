...
# ----------------------------------------------------------------------
# PM Atlas domain motifs — clean geometric glyphs (accent = currentColor)
# ----------------------------------------------------------------------
_PM_COMPASS = '''
<circle cx="140" cy="92" r="46" fill="var(--il-paper)" stroke="var(--il-ink)" stroke-width="2.6"/>
<circle cx="140" cy="92" r="46" fill="currentColor" opacity=".35"/>
<path d="M140 58 L153 92 L140 126 L127 92 Z" fill="currentColor" stroke="var(--il-ink)" stroke-width="2.2" stroke-linejoin="round"/>
<path d="M140 58 L153 92 L127 92 Z" fill="var(--il-foam)" opacity=".85"/>
<circle cx="140" cy="92" r="4" fill="var(--il-ink)"/>
<g stroke="var(--il-ink)" stroke-width="2" stroke-linecap="round" opacity=".55">
<line x1="140" y1="42" x2="140" y2="49"/><line x1="140" y1="135" x2="140" y2="142"/>
<line x1="90" y1="92" x2="97" y2="92"/><line x1="183" y1="92" x2="190" y2="92"/></g>
'''

_PM_FOUNDATION = '''
<g stroke="var(--il-ink)" stroke-width="2.4" stroke-linejoin="round">
<rect x="98" y="116" width="84" height="22" rx="3" fill="currentColor"/>
<rect x="92" y="92" width="44" height="22" rx="3" fill="var(--il-paper)"/>
<rect x="140" y="92" width="48" height="22" rx="3" fill="var(--il-paper)"/>
<rect x="112" y="68" width="56" height="22" rx="3" fill="currentColor" opacity=".7"/></g>
<ellipse cx="140" cy="150" rx="48" ry="6" fill="var(--il-ink)" opacity=".14"/>
'''

_PM_EXECUTION = '''
<rect x="104" y="56" width="72" height="72" rx="14" fill="currentColor" stroke="var(--il-ink)" stroke-width="2.6"/>
<path d="M120 92 l13 14 26 -32" fill="none" stroke="var(--il-foam)" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
<g stroke="var(--il-ink)" stroke-width="2.4" stroke-linecap="round" opacity=".5">
<line x1="78" y1="72" x2="96" y2="72"/><line x1="72" y1="92" x2="96" y2="92"/><line x1="78" y1="112" x2="96" y2="112"/></g>
'''

_PM_INSIGHT = '''
<circle cx="128" cy="86" r="34" fill="currentColor" opacity=".38"/>
<circle cx="128" cy="86" r="34" fill="none" stroke="var(--il-ink)" stroke-width="2.8"/>
<line x1="151" y1="109" x2="180" y2="138" stroke="var(--il-ink)" stroke-width="6" stroke-linecap="round"/>
<g stroke="var(--il-foam)" stroke-width="3.6" stroke-linecap="round">
<line x1="116" y1="98" x2="116" y2="88"/><line x1="128" y1="98" x2="128" y2="74"/><line x1="140" y1="98" x2="140" y2="82"/></g>
'''

_PM_STRATEGY = '''
<circle cx="136" cy="94" r="42" fill="var(--il-paper)" stroke="var(--il-ink)" stroke-width="2.6"/>
<circle cx="136" cy="94" r="27" fill="currentColor" opacity=".45" stroke="var(--il-ink)" stroke-width="2.2"/>
<circle cx="136" cy="94" r="11" fill="currentColor" stroke="var(--il-ink)" stroke-width="2.2"/>
<line x1="148" y1="66" x2="188" y2="40" stroke="var(--il-ink)" stroke-width="3" stroke-linecap="round"/>
<path d="M188 40 l-12 1 5 11 Z" fill="var(--il-foam)" stroke="var(--il-ink)" stroke-width="1.6" stroke-linejoin="round"/>
'''

_PM_PEOPLE = '''
<g stroke="var(--il-ink)" stroke-width="2.4" stroke-linecap="round">
<line x1="110" y1="120" x2="140" y2="66"/><line x1="170" y1="120" x2="140" y2="66"/><line x1="110" y1="120" x2="170" y2="120"/></g>
<circle cx="140" cy="64" r="16" fill="currentColor" stroke="var(--il-ink)" stroke-width="2.4"/>
<circle cx="108" cy="124" r="14" fill="var(--il-paper)" stroke="var(--il-ink)" stroke-width="2.4"/>
<circle cx="172" cy="124" r="14" fill="var(--il-paper)" stroke="var(--il-ink)" stroke-width="2.4"/>
'''

_PM_LADDER = '''
<path d="M100 140 L132 140 L132 112 L160 112 L160 84 L188 84 L188 58" fill="none" stroke="var(--il-ink)" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"/>
<g fill="currentColor"><rect x="100" y="133" width="32" height="8"/><rect x="132" y="105" width="28" height="8"/><rect x="160" y="77" width="28" height="8"/></g>
<circle cx="188" cy="52" r="8" fill="currentColor" stroke="var(--il-ink)" stroke-width="2.2"/>
<ellipse cx="140" cy="150" rx="48" ry="6" fill="var(--il-ink)" opacity=".14"/>
'''

_PM_ASSESS = '''
<path d="M96 124 a44 44 0 0 1 88 0" fill="none" stroke="var(--il-ink)" stroke-width="3" stroke-linecap="round"/>
<path d="M96 124 a44 44 0 0 1 26 -38" fill="none" stroke="currentColor" stroke-width="7" stroke-linecap="round"/>
<line x1="140" y1="124" x2="166" y2="92" stroke="var(--il-ink)" stroke-width="3.2" stroke-linecap="round"/>
<circle cx="140" cy="124" r="6" fill="var(--il-ink)"/>
<g stroke="var(--il-ink)" stroke-width="2" stroke-linecap="round" opacity=".5">
<line x1="100" y1="110" x2="106" y2="107"/><line x1="140" y1="80" x2="140" y2="86"/><line x1="180" y1="110" x2="174" y2="107"/></g>
'''

_PM_TOOLKIT = '''
<rect x="100" y="54" width="80" height="80" rx="6" fill="var(--il-paper)" stroke="var(--il-ink)" stroke-width="2.6"/>
<line x1="140" y1="54" x2="140" y2="134" stroke="var(--il-ink)" stroke-width="2.4"/>
<line x1="100" y1="94" x2="180" y2="94" stroke="var(--il-ink)" stroke-width="2.4"/>
<rect x="106" y="60" width="28" height="28" rx="3" fill="currentColor" opacity=".75"/>
<rect x="146" y="100" width="28" height="28" rx="3" fill="currentColor" opacity=".4"/>
'''

_PM_AI = '''
<rect x="108" y="60" width="64" height="64" rx="10" fill="currentColor" stroke="var(--il-ink)" stroke-width="2.6"/>
<g stroke="var(--il-ink)" stroke-width="2.4" stroke-linecap="round">
<line x1="124" y1="60" x2="124" y2="48"/><line x1="140" y1="60" x2="140" y2="48"/><line x1="156" y1="60" x2="156" y2="48"/>
<line x1="124" y1="124" x2="124" y2="136"/><line x1="140" y1="124" x2="140" y2="136"/><line x1="156" y1="124" x2="156" y2="136"/>
<line x1="108" y1="78" x2="96" y2="78"/><line x1="108" y1="106" x2="96" y2="106"/>
<line x1="172" y1="78" x2="184" y2="78"/><line x1="172" y1="106" x2="184" y2="106"/></g>
<path d="M142 74 l-12 20 h9 l-5 18 16 -24 h-9 Z" fill="var(--il-foam)" stroke="var(--il-ink)" stroke-width="1.4" stroke-linejoin="round"/>
'''

_PM_REFERENCE = '''
<g stroke="var(--il-ink)" stroke-width="2.4" stroke-linejoin="round">
<rect x="96" y="118" width="88" height="16" rx="2" fill="currentColor" opacity=".5"/>
<rect x="104" y="100" width="76" height="16" rx="2" fill="var(--il-paper)"/>
<rect x="110" y="62" width="60" height="36" rx="3" fill="currentColor"/></g>
<line x1="140" y1="62" x2="140" y2="98" stroke="var(--il-foam)" stroke-width="2.6"/>
<ellipse cx="140" cy="146" rx="48" ry="6" fill="var(--il-ink)" opacity=".14"/>
'''


def domain_illustration(folder, color):
    inner = {
        "01_introduction":            _PM_COMPASS,
        "02_foundations":             _PM_FOUNDATION,
        "03_product_execution":       _PM_EXECUTION,
        "04_customer_insight":        _PM_INSIGHT,
        "05_product_strategy":        _PM_STRATEGY,
        "06_influencing_people":      _PM_PEOPLE,
        "07_career_ladder":           _PM_LADDER,
        "08_assessment_and_coaching": _PM_ASSESS,
        "09_frameworks_toolkit":      _PM_TOOLKIT,
        "10_ai_and_modern_pm":        _PM_AI,
        "11_reference":               _PM_REFERENCE,
    }.get(folder, _PM_COMPASS)
