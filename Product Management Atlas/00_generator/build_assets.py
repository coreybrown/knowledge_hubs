# -*- coding: utf-8 -*-
"""Design assets (CSS + JS) for The Product Manager's Atlas site."""

CSS = r"""
/* ============================================================
   The Product Manager's Atlas — design system
   ============================================================ */
:root{
  --bg:#EEF1F6; --bg-grad:#DEE5F0;
  --surface:#FFFFFF; --surface-2:#ECF0F7; --surface-3:#DDE4F0;
  --ink:#19212E; --ink-2:#3A465A; --ink-3:#6C7A90;
  --border:#D6DEEA; --border-2:#BDC9DA;
  --accent:#3B5BA5; --accent-2:#5C7CC4; --accent-deep:#2C467F;
  --accent-soft:#D6E0F4;
  --link:#3B5BA5; --link-hover:#27407A;
  --hop:#5C7CC4; --hop-deep:#2C467F;
  --il-ink:#19212E; --il-paper:#EEF2F9; --il-foam:#F8FAFE;
  --il-glass:rgba(238,242,249,.55); --il-beer:#3B5BA5;
  --shadow:0 1px 2px rgba(20,30,55,.07),0 8px 24px -10px rgba(20,30,55,.18);
  --shadow-lg:0 4px 12px rgba(20,30,55,.12),0 30px 60px -24px rgba(20,30,55,.34);
  --radius:16px;
...
html[data-theme="dark"]{
  --bg:#0B0E14; --bg-grad:#10151E;
  --surface:#141A24; --surface-2:#1B2330;
  --surface-3:#243040;
  --ink:#E7ECF5; --ink-2:#AEBCD0; --ink-3:#7C8BA3;
  --border:#28323F; --border-2:#3A4757;
  --accent:#7E9CE0; --accent-2:#9DB6EC; --accent-deep:#9DB6EC;
  --accent-soft:#1E2A40;
  --link:#8FAAE8; --link-hover:#B3C6F2;
  --hop:#8FAAE8; --hop-deep:#B9CBF0;
  --il-ink:#E7ECF5; --il-paper:#AEB9CC; --il-foam:#C7D2E4;
  --il-glass:rgba(231,236,245,.16); --il-beer:#5C7CC4;
...
JS = r"""
/* The Product Manager's Atlas — interactivity */
(function(){
  "use strict";
  ...
  var ASK_TOPIC="product management";
  var ASK_GUIDE="pm-atlas";
  var ASK_EG=["What does a Senior PM need that a PM doesn't?",
              "How is AI changing product management?",
              "How do I write a PRD that drives delivery?"];
