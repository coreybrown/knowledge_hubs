---
tags: [career-ladder, director, vp-product, level, manager-track]
aliases: [Director and VP of Product, Director of Product, VP of Product, VP Product]
domain: The Product Career Ladder
---

# Director and VP of Product
...
|---|---|---|
| **Director** | Implements strategy; leads complex issues to focused solutions; runs collaborative cross-functional process across a department. | Consultative direction across multiple teams; directs *multilayered* managers. |
| **(Senior Director)** | Moves from *implementing* to *setting* functional strategy; impacts org objectives and long-term performance. | Sets strategic direction across functions; begins to impact orgs *outside* their own; manages multilayered directors. |
| **VP** | Executes functional business plans; contributes to functional and business *strategy*; collaborates with exec leadership. | Full autonomy; leads through a *management team*. |

The throughline: **leading through managers** and **setting (not just executing) strategy.** A VP's hands are nowhere near a Jira board.

## The competencies at the leadership level

The same [[The PM Competency Model|twelve]], at the highest org altitude. Two clusters dominate.

| Competency | What it looks like here |
|---|---|
| [[Strategic Impact]] | *Sets* functional/business strategy; anticipates industry risk and leverage points ([[Business Acumen and Models]], [[The DHM Model]]). |
| [[Product Vision and Roadmapping]] | Owns the vision for a large portfolio; reconciles and funds roadmaps across many teams. |
| [[Business Outcome Ownership]] | Accountable for *business-line* outcomes, not feature outcomes. |
| **[[Team Leadership]]** | *Product-wide* leadership: builds the org structure, the [[Hiring and Building a Product Team\|hiring]] machine, the standards, the **product culture**; develops managers, not just PMs. |
| [[Stakeholder Management]] | Peer to other functional VPs; manages the most senior [[Internal and External Stakeholders\|stakeholders]]. |
| [[Managing Up]] / [[Executive Communication]] | Operates *as* an executive; frames product in P&L terms to the CEO and board. |

> [!note] The work is now organizational design
> At this altitude, "doing product" means deciding *how product gets done*: team topology ([[Product Teams vs Feature Teams]]), the operating model ([[The Product Organization Matrix]]), how strategy cascades ([[OKRs and Goal-Setting]]), and who you hire and promote ([[Calibration and Promotion]]). You're building the *system that builds the product.*
