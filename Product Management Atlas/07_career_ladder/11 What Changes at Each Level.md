---
tags: [career-ladder, leveling, escalation, framework]
aliases: [What Changes at Each Level, The Escalation Axes, What Changes by Level, The Four Dials]
...
| Axis | The question it answers | Low → High |
|---|---|---|
| **Scope** | How big is what you own? | One feature → a product area → a portfolio → a business → the company |
| **Autonomy** | How much do you decide alone? | Execute a defined task → set your own plan → set the team's strategy → set company direction |
| **Ambiguity** | How undefined is the problem when it reaches you? | Problem fully framed → ill-defined → *you define the problem* |
| **Influence** | How far does your impact reach? | Your own work → your team → the org → the market/field |

## The dials, rung by rung

| Level | Scope | Autonomy | Ambiguity | Influence |
|---|---|---|---|---|
| [[Associate Product Manager\|APM]] | A feature | Works under supervision | Problem handed over framed | Self |
| [[Product Manager\|PM]] | A product area | Sets own priorities | Frames the work themselves | Begins to reach the team |
| [[Senior Product Manager\|Senior]] | Complex / interrelated areas | Fully independent; role model | Brings clarity to ill-defined work | Across the team |
| [[Staff and Principal Product Manager\|Staff/Principal]] | Cross-team initiatives | Defines context for others | Tackles the most ambiguous problems | Org-wide (no headcount) |
| [[Group Product Manager\|GPM]] | A group, *through PMs* | Owns the team's plan | Absorbs ambiguity for the team | The team's output |
| [[Director and VP of Product\|Director/VP]] | A domain / business line, *through managers* | Sets functional strategy | Defines which problems matter | The function / org culture |
| [[The Chief Product Officer\|CPO]] | The company | Co-sets company strategy | Defines the problem space itself | The company / the market |

## The fork, read through the dials
